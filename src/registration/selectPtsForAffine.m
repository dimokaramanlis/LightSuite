function ikeep = selectPtsForAffine(cptshistology, cptsatlas)
...
gmdist    = fitgmdist(cptshistology, 1);
distances = gmdist.mahal(cptshistology);
[~, isort] = sort(distances, 'descend');
ikeep      = isort(1:floor(numel(distances)*0.8));
