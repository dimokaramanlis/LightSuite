...
% straightvol      = imwarp(straightvol, Rvolume, regopts.affine_atlas_to_samp.invert, 'OutputView',Rvolume);
...
slicescheck     = round(linspace(1, size(regopts.straightvol, 3), 60))';
...
gui_data.atlas_slice = ...
    gui_data.atlas_slice + 2* eventdata.VerticalScrollCount;
...
gui_data.atlas_ax.Title.String = sprintf("Slice %d/%d", sluse, atlasize(idim));
